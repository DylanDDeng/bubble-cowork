...
export type WeChatCopyResult =
  | {
      ...
      model?: string;
      providerId?: string;
      runtime?: 'claude' | 'codex' | 'opencode' | 'kimi' | 'grok' | 'pi' | 'qoder' | 'bubble' | 'deepseek';
    }
...
async function copyWechatHtmlPayload(
  ...
  meta?: { model?: string; providerId?: string; runtime?: 'claude' | 'codex' | 'opencode' | 'kimi' | 'grok' | 'pi' | 'qoder' | 'bubble' | 'deepseek' },
