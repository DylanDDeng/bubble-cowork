...
const PAPER_LIGHT: ThemeVariables = {
  ...
  '--tree-file-accent-bg': '#EEF2FF',
  '--tree-file-accent-border': '#DCDFFF',
  '--tree-file-accent-fg': '#5B57D8',
  '--tree-file-media-bg': '#EEF5FF',
  '--tree-file-media-border': '#D9E8FF',
  '--tree-file-media-fg': '#3569E8',
...
const PAPER_DARK: ThemeVariables = {
  ...
  '--tree-file-accent-bg': '#23283A',
  '--tree-file-accent-border': '#374151',
  '--tree-file-accent-fg': '#A5B4FC',
  '--tree-file-media-bg': '#1C2A38',
